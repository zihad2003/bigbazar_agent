...
export function orderFormReply() {
  return (
    `অর্ডার করতে এই তথ্যগুলো একসাথে পাঠান:\n` +
    `নাম:\nমোবাইল:\nঠিকানা:\n\n` +
    `ডেলিভারি: মীরসরাই ফ্রি, চট্টগ্রাম ১০০, সারা দেশ ১৫০ টাকা।`
  );
}
...
export function missingFieldsReply(errors) {
  ...
  return (
    `অর্ডার কনফার্ম করতে নাম, সঠিক মোবাইল নম্বর (01X...) এবং সম্পূর্ণ ঠিকানা দিন।\n\n` +
    `নাম:\nমোবাইল:\nঠিকানা:`
  );
}
